...
<div id="content">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <p><strong><i class="fas fa-user-clock"></i>&nbsp;&nbsp;Ult. Atualização :&nbsp;</strong>  <?php echo formata_data_banco_com_hora($vendedor->vendedor_data_alteracao); ?></p>
            ...
            <form class="user" method="POST" name="form_add">
                ...
                <fieldset class="mt-4 border p-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <label>RG</label>
                            <input type="text" class="form-control form-control-user-date rg" name="vendedor_rg" value="<?php echo $vendedor->vendedor_rg; ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <label>Fone 2</label>
                            <input type="text" class="form-control form-control-user" name="vendedor_telefone"  value="<?php echo $vendedor->vendedor_telefone; ?>">
                            <?php echo form_error('vendedor_telefone', '<small class="form-text text-danger">', '</small>') ?>
                        </div>
                        <div class="col-md-3">
                            <label>Celular</label>
                            <input type="text" class="form-control form-control-user" name="vendedor_celular"  value="<?php echo $vendedor->vendedor_celular; ?>">
                ...
                <fieldset class="mt-4 border p-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            ...
                            <input type="text" class="form-control form-control-user" name="vendedor_obs"  value="<?php echo $vendedor->vendedor_obs; ?>">
