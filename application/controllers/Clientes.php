...
class Clientes extends CI_Controller {
    ...
    public function index() {
        ...
        $data = array(
            ...
            'tab_cliente' => $this->core_model->get_all('clientes'),
        );
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('cliente_nome', '', 'required|max_length[45]');
        $this->form_validation->set_rules('cliente_sobrenome', '', 'required|max_length[150]');
        ...
        if (!empty($this->input->post('cliente_telefone'))) {
            $this->form_validation->set_rules('cliente_telefone', '', 'trim|max_length[15]|is_unique[clientes.cliente_telefone]|callback_check_telefone');
        }

        $this->form_validation->set_rules('cliente_email', '', 'trim|valid_email|max_length[50]|is_unique[clientes.cliente_email]');
        $this->form_validation->set_rules('cliente_rg_ie', '', 'trim|max_length[20]|is_unique[clientes.cliente_rg_ie]|callback_check_rg_ie');
